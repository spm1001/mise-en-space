...
_LEGACY_SIZE_BASELINE = {
    ...
    "tools/create.py": 933,  # tightened 2026-08-09 thrice: find_placeholder_indices moved to doc_chips.py, de-aliased imports (mise-rafote), csv_text_to_values moved to extractors/sheets.py (mise-kacani). +11 (2026-08-24, mise-bapije cold review): source reads and enrich_manifest under the per-resource deposit lock — unlocked they raced a concurrent fetch's wipe-and-rewrite (torn read / stale-manifest clobber)
