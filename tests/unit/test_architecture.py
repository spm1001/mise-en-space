...
_LEGACY_SIZE_BASELINE = {
    ...
    "tools/fetch/drive.py": 806,  # tightened 2026-08-08: _write_per_tab_csvs moved to common.py (mise-dogape); +1 (2026-08-13): pdf_page_fidelity spread in fetch_pdf's manifest extras — logic lives in common.py (mise-wujoga)
