...
_LEGACY_SIZE_BASELINE = {
    ...
    "adapters/gmail.py": 1068,  # +2 (2026-09-23, mise-mudupa): call-site wiring only — one import and one with_attachments() call in _build_draft_message (plus the pass-through param on update_draft); the MIME wrapping and the draft attachment scan live in adapters/gmail_draft_attachments.py. The call must sit where the message is built. Earlier: tightened 2026-08-07: id resolvers split to gmail_ids.py
