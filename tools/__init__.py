...
from .comment_reply import do_comment_reply
...
OPERATIONS = frozenset({
    ...
    "draft", "reply_draft", "archive", "star", "label", "comment_reply",
    "setup_oauth",
})
...
__all__ = [
    ...
    "do_archive", "do_star", "do_label", "do_comment_reply", "do_setup_oauth", "OPERATIONS",
]
