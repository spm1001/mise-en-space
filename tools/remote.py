...
def fetch_remote(file_id: str, base_path: str, attachment: str | None, *, recursive: bool = False, tabs: list[str] | None = None, suggestions: str = "accepted", thumbnails: bool = True, crops: bool = True) -> dict[str, Any]:
    """
    ...
    if base_path:
        ...
        effective_base = Path(temp_dir)
    try:
        result = do_fetch(file_id, base_path=effective_base, attachment=attachment, recursive=recursive, tabs=tabs, suggestions=suggestions, thumbnails=thumbnails, crops=crops)
